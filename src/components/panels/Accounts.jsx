...
export default function AccountsPanel() {
  return (
    <div className="account-panel-content">
      ...
      >
        <span className="avatar" style={{ fontSize: 56, marginBottom: 8 }}>
          👨‍💻
        </span>
        <strong style={{ fontSize: 18, marginBottom: 1 }}>Philippe Langlois</strong>
        <span className="status" style={{ fontSize: 15, marginBottom: 8, color: "#27d158" }}>
          🟢 Disponible
        </span>
      </div>
      ...
      <ul className="contact-list" style={{ listStyle: "none", padding: 0, margin: 0 }}>
        <li style={{ display: "flex", alignItems: "center", marginBottom: 7 }}>
          ...
          <span style={{ fontSize: 15, marginLeft: 5 }}> lngs.philippe@gmail.com</span>
        </li>
        <li style={{ display: "flex", alignItems: "center", marginBottom: 7 }}>
      ...
      <div className="links" style={{ display: "flex", justifyContent: "center", gap: 14, marginTop: 8 }}>
        ...
        <a href="mailto:lngs.philippe@gmail.com" title="Envoyer un mail" style={{ fontSize: 23 }}>
          <span
            style={{ fontSize: 20, marginRight: 10, color: "white" }}
            className="codicon codicon-mail"
          />
        </a>
        <a
          href="https://www.linkedin.com/in/42-langlois-philippe"
          target="_blank"
          rel="noopener noreferrer"
          title="LinkedIn"
        >
          <img src={LinkIcon} alt="LinkedIn" style={{ width: 20, height: 20 }} />
        </a>
      </div>
    </div>
  );
